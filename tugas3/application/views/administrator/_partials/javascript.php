<script src="https://code.jquery.com/jquery-3.3.1.min.js" integrity="sha256-FgpCb/KJQlLNfOu91ta32o/NMZxltwRo8QtmkMRdAu8=" crossorigin="anonymous"></script>
		...
		<script src="<?= base_url("assets/administrator/") ?>scripts/extras.1.1.0.min.js"></script>
		<script src="<?= base_url("assets/administrator/") ?>scripts/shards-dashboards.1.1.0.min.js"></script>
			...
			$(document).ready(function() {
				$("#keluar").click(function() {
					...
					.then((yes) => {
						if (yes) {
							$.ajax({
								url: `<?= base_url() ?>`+`api/otentikasi/keluar`,
								dataType: "json",
								type: "GET",
